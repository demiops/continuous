...
class CredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post credentials_url, params: { credential: { clouddata: @credential.clouddata, cloudkey: @credential.cloudkey, cloudsecret: @credential.cloudsecret, cloudtoken: @credential.cloudtoken, cloudtype: @credential.cloudtype } }
    end
  ...
  test "should update credential" do
    patch credential_url(@credential), params: { credential: { clouddata: @credential.clouddata, cloudkey: @credential.cloudkey, cloudsecret: @credential.cloudsecret, cloudtoken: @credential.cloudtoken, cloudtype: @credential.cloudtype } }
