...
class ClustersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cluster" do
    assert_difference('Cluster.count') do
      post clusters_url, params: { cluster: { clusterendpoints: @cluster.clusterendpoints, clustername: @cluster.clustername, clusterpassword: @cluster.clusterpassword, clusterstatus: @cluster.clusterstatus, clusterusername: @cluster.clusterusername } }
    end
  ...
  test "should update cluster" do
    patch cluster_url(@cluster), params: { cluster: { clusterendpoints: @cluster.clusterendpoints, clustername: @cluster.clustername, clusterpassword: @cluster.clusterpassword, clusterstatus: @cluster.clusterstatus, clusterusername: @cluster.clusterusername } }
